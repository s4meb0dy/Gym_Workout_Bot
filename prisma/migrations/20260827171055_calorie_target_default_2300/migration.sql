...
CREATE TABLE "new_ReminderSetting" (
    ...
    "calorieTarget" INTEGER NOT NULL DEFAULT 2300,
...
INSERT INTO "new_ReminderSetting" ("backupEnabled", "calorieTarget", "chatId", "digestEnabled", "id", "proteinEnabled", "proteinHour", "proteinTarget", "supplementsEnabled", "supplementsHour", "userId", "waterEnabled", "waterTargetMl", "workoutEnabled", "workoutHour") SELECT "backupEnabled", "calorieTarget", "chatId", "digestEnabled", "id", "proteinEnabled", "proteinHour", "proteinTarget", "supplementsEnabled", "supplementsHour", "userId", "waterEnabled", "waterTargetMl", "workoutEnabled", "workoutHour" FROM "ReminderSetting";
...
-- До цієї версії ціль калорій не мала UI у боті, тому лишалася на старому
-- дефолті 2000. Піднімаємо лише ті рядки, які його не змінювали.
UPDATE "ReminderSetting" SET "calorieTarget" = 2300 WHERE "calorieTarget" = 2000;
